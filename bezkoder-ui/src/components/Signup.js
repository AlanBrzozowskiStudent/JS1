...
function Signup() {
    ...
    const validatePhone = (phone) => {
        return /^\d{9}$/.test(phone); // Sprawdza, czy numer telefonu zawiera dokładnie 9 cyfr
    };
            ...
            <Card className="w-100" style={{ maxWidth: "400px" }}>
                <Card.Body>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Button className="mt-3 w-100 btn btn-secondary"><Nav.Link as={Link} to="/login">Back to login</Nav.Link></Button> 
                    </Form>
                </Card.Body>
            </Card>
        </Container>
